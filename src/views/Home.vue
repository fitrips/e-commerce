...
<section class="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md text-center">
      <h2 class="font-serif text-2xl font-bold sm:text-3xl"> August Sale</h2>
      <p class="mt-4 text-base text-gray-700">Some Harry Winston Jewelry on sale.</p>
    </div>
    ...
    <div class="mt-10 grid grid-cols-2 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/cincin2.jpg" alt="" />
        </div>
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/kalung1.webp" alt="" />
        </div>
        <div class="mt-4 flex items-start justify-between">
          <div class="">
            <h3 class="text-xs font-semibold sm:text-sm md:text-base">
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="../assets/img/anting.png" alt="" />
        </div>
        <div class="absolute top-0 m-1 rounded-full bg-white">
          <p class="text-[10px] rounded-full bg-black p-1 font-bold uppercase tracking-wide text-white sm:px-3 sm:py-1">Sale</p>
        </div>
...
<section class="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md text-center">
      <h2 class="font-serif text-2xl font-bold sm:text-3xl">Product Harry Winston</h2>
      <p class="mt-4 text-base text-gray-700">some jewelry products that are in great demand by women</p>
    </div>
<div class="container mx-auto px-20 py-8 lg:px-32 lg:pt-24">
    ...
    <div class="flex w-1/2 flex-wrap">
      <div class="w-full p-1 md:p-2">
        <img
          ...
          src="../assets/img/kalung4.webp" />
      </div>

    </div>
    <div class="flex w-1/2 flex-wrap">

      <div class="w-3/4 p-1 md:p-2">
        <img
          alt="gallery"
          class="block h-full w-full rounded-lg object-cover object-center"
          src="../assets/img/gelanghw.webp" />
      </div>
      <div class="w-3/4 p-1 md:p-2">
        <img
          alt="gallery"
          class="block h-full w-full rounded-lg object-cover object-center border-black" 
