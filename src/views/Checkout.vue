<template>
  ...
  <a href="#" class="text-2xl font-bold text-gray-800">HWinston</a>
  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="../assets/img/kalungpro2.webp" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Necklace Blue</span>
          <span class="float-right text-gray-400">300 g</span>
          <p class="text-lg font-bold">$259.00</p>
        </div>
      </div>
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="../assets/img/kpro4.webp" alt="" />
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">Necklace Ocean</span>
          <span class="float-right text-gray-400">224 g</span>
          <p class="mt-auto text-lg font-bold">$259.00</p>
        </div>
      </div>
    </div>
